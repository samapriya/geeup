...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3935753.svg)](https://doi.org/10.5281/zenodo.3935753)
...
```
Samapriya Roy. (2020, July 8). samapriya/geeup: geeup: Simple CLI for Earth Engine Uploads (Version 0.4.1).
Zenodo. http://doi.org/10.5281/zenodo.3935753
```
